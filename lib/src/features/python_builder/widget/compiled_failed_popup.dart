...
class CompiledFailedPopup extends StatefulWidget {
  final VoidCallback? onClose;
  final VoidCallback? onShowInformation;

  const CompiledFailedPopup({
    super.key,
    this.onClose,
  ...
  @override
  State<CompiledFailedPopup> createState() => _CompiledFailedPopupState();
}

class _CompiledFailedPopupState extends State<CompiledFailedPopup> {
  @override
